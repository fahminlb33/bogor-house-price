...
class TrainCatBoost(TrainerMixin):
  ...
  def load_data(self):
    ...
    self.train_pool = Pool(
        data=self.X, label=self.y, cat_features=self.cat_cols)
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--learning_rate", help="Learning rate", default=0.05683273851486543)
  parser.add_argument("--min_data_in_leaf", help="Min data in leaf", default=89)
  parser.add_argument(
      "--subsample", help="Subsample", default=0.851934076287287)
