...
class TrainRandomForest(TrainerMixin):
  ...
  def __init__(self, dataset_path: str, output_path: str, bootstrap: bool,
               max_depth: int, max_features: str | None, min_samples_leaf: int,
               min_samples_split: int, n_estimators: int, n_jobs: int,
               random_state: int):
    super().__init__()
...
if __name__ == "__main__":
  ...
  parser.add_argument("--min_samples_leaf", help="Min samples leaf", default=1)
  parser.add_argument(
      "--min_samples_split", help="Min samples split", default=2)
