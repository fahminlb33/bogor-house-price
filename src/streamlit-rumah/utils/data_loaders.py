...
def fact_price_by_district():
    return (
        pd.read_csv("assets/data/marts_dashboard_fact_price_by_district.csv")
...
def fact_listing_by_district():
    return (
        pd.read_csv("assets/data/marts_dashboard_fact_listing_by_district.csv")
        .merge(dim_districts(), on="district_sk")
        .set_index("district_sk")
    )
...
def fact_price():
    return (
        pd.read_csv("assets/data/marts_dashboard_fact_price.csv")
        .merge(dim_districts(), on="district_sk")
        .set_index("district_sk")
    )
...
def fact_price_ratio():
    return (
        pd.read_csv("assets/data/marts_dashboard_fact_price_ratio.csv")
        .merge(dim_districts(), on="district_sk")
        .set_index("district_sk")
    )
