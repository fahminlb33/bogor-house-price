...
class UserSession(Base):
    ...
    prompts: Mapped[list["OpenAIPrompt"]] = relationship(back_populates="session")
    predictions: Mapped[list["Prediction"]] = relationship(back_populates="session")
...
class OpenAIPrompt(Base):
    ...
    responses: Mapped[list["OpenAIResponse"]] = relationship(back_populates="prompt")
