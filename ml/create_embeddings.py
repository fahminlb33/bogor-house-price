...
from ml_llm import EmbeddingDocumentTemplateEngine
...
class CreateEmbeddingsPipeline(TrainerMixin):
    ...
    def train(self):
        ...
        # print statistics
        self.logger.info(
            f"Total documents: {stats['store']['documents_written']}")
        ...
        with open(filename, "w") as f:
            data = {
                "total_documents":
                    stats['store']['documents_written'],
                "model":
                    stats['embedder']["meta"]["model"],
                "total_tokens":
                    stats['embedder']["meta"]["usage"]["total_tokens"],
                "prompt_tokens":
                    stats['embedder']["meta"]["usage"]["prompt_tokens"],
            }
